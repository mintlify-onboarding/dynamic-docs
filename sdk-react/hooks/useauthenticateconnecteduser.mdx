...
description: "A hook which can be used to authenticate already connected user. It's useful when there is need to authenticate user in connect-only mode. The hook needs to be initialized within a child of `DynamicContextProvier`"
---
