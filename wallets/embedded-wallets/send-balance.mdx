---
title: "Send Balance"
description: "Dynamic Send Balance Widget allows users to send their funds to another wallet when using an embedded wallet. Users using embedded wallets will automatically have a send button in the dynamic widget, or you can trigger the same UI from your website using our `useSendBalance` hook."
---
