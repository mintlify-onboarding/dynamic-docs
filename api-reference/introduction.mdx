---
title: "Introduction"
description: "Dynamic provides a robust API that allows developers to securely access their dashboard environment's data and programmatically update settings relevant to their Dynamic-powered application."
---
...
5. The token should start with the prefix dyn\_ followed by 56 alphanumeric characters.
...
```bash curl
curl \
--location 'https://app.dynamic.xyz/api/v0/environments/Enter your Environment ID here' \
